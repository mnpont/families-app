...
/**
 * The Multiple Choice exercise -- what the Practice tab showed before the
 * hub (docs/practice-mc-spec.md). Launched from PracticeView's hub; its
 * logic and screen are unchanged by the hub's introduction.
 */
export function MultipleChoiceView({ languageId }: MultipleChoiceViewProps) {
